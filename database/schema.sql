...
CREATE TABLE IF NOT EXISTS questions (
    ...
    FOREIGN KEY (parent_category_id, parent_library_id) REFERENCES categories(category_id, parent_library_id),
...
CREATE TABLE IF NOT EXISTS has_completed (
    ...
    FOREIGN KEY (category_id, parent_library_id) REFERENCES categories(category_id, parent_library_id),
